...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String secretMessage = "All your bases belong to us!";
    ...
    private void shareText(String secretMessage) {
